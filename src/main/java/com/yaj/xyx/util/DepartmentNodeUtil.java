 ...
 * 多叉树类 
*/  
public class DepartmentNodeUtil {  
 public String getJasonString(List<UserDepartmentTree> dataList) {  
  // 读取层次数据结果集列表   
  ...
  // 根据结果集构造节点列表（存入散列表）  
  for (UserDepartmentTree it :dataList) {  
	   Node node = new Node();  
	   node.value = it.getId().toString();  
