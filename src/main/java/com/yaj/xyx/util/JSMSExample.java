...
//    	testSendSMSCode();
    	...
    	testSendTemplateSMS("17612167237","123456");
...
//        testSendTemplateSMS();
	...
	public static boolean testSendTemplateSMS(String mobile,String code) {
	    SMSClient client = new SMSClient(masterSecret, appkey);
        SMSPayload payload = SMSPayload.newBuilder()
	...
	public static boolean testSendDiySMS(String mobile,NoticePO no) {
	    SMSClient client = new SMSClient(masterSecret, appkey);
        SMSPayload payload = SMSPayload.newBuilder()
                .setMobileNumber(mobile)
                .setTempId(171916)//
                .addTempPara("title", no.getTitle())
                .addTempPara("content", no.getContent())
                .build();
        try {
            SendSMSResult res = client.sendTemplateSMS(payload);
            LOG.info(res.toString());
	...
	//公告手机短信批量推送
    public static void testSendBatchTemplateSMS(List<JasoUserPO> userList,NoticePO no ) {
        SMSClient client = new SMSClient(masterSecret, appkey);
        ...
        for(int i=0;i<userList.size();i++){
        	RecipientPayload recipientPayload = new RecipientPayload.Builder()
                    .setMobile(userList.get(i).getUserTel())
                    .addTempPara("title", no.getTitle())
                    .build();
