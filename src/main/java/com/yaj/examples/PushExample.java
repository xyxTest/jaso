...
public class PushExample {
    ...
    public static final String TITLE = "干干干！";
    public static final String ALERT = "我那个擦！";
...
//        testBatchSend();
    	...
    	push.setContent("测试一下啊");
    	push.setTitle("工作任务单状态推送");
    	List<String> userIds = new ArrayList<>();
    	userIds.add("1");
       // testSendPushWithCustomConfig(push,userIds);
        //buildPushObject_all_alias_alert();
//        testSendIosAlert();
//		testSendPush();
//        testGetCidList();
//        testSendPushes();
        //testSendPush_fromJSON(json.toString());
...
//        PushPayload payload = buildPushObject_all_alias_alert();
    ...
    public static void testSendPush_fromJSON(String json) {
        ClientConfig clientConfig = ClientConfig.getInstance();
       ...
       // String payloadString = "{\"platform\":{\"all\":false,\"deviceTypes\":[\"IOS\"]},\"audience\":{\"all\":true,\"targets\":[{\"audienceType\":\"TAG_AND\",\"values\":[\"tag1\",\"tag_all\"]}]},\"notification\":{\"notifications\":[{\"soundDisabled\":false,\"badgeDisabled\":false,\"sound\":\"happy\",\"badge\":\"5\",\"contentAvailable\":false,\"alert\":\"Test from API Example - alert\",\"extras\":{\"from\":\"JPush\"},\"type\":\"cn.jpush.api.push.model.notification.IosNotification\"}]},\"message\":{\"msgContent\":\"Test from API Example - msgContent\"},\"options\":{\"sendno\":1429488213,\"overrideMsgId\":0,\"timeToLive\":-1,\"apnsProduction\":true,\"bigPushDuration\":0}}";
        ...
        try {
            PushResult result = jpushClient.sendPush(json);
            LOG.info("Got result - " + result);
...
//        ApacheHttpClient httpClient = new ApacheHttpClient(authCode, null, clientConfig);
    ...
    ////////////广播推送
    public static PushPayload buildPushObject_all_alias_alert(PushModel push,List<String> userIds) {
        return PushPayload.newBuilder()
                .setPlatform(Platform.all())
                .setAudience(Audience.alias(userIds))
                .setNotification(
                		Notification.newBuilder()
                        .setAlert(push.getTitle())
                        .addPlatformNotification(
                        		AndroidNotification.newBuilder()
                        		.addExtra("title",push.getTitle())
                        		.addExtra("content", push.getContent())
                                .build()
                                ).build())
                .build();
    }
...
//                .setAudience(Audience.registrationId("1507bfd3f79558957de"))
    ...
    public void testSendPushWithCustomConfig(PushModel push,List<String> userIds) {
        ...
        // For push, all you need do is to build PushPayload object.
        PushPayload payload = buildPushObject_all_alias_alert(push,userIds);
